        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '4rem' }}>
          <div style={{ flex: '1 1 400px', color: 'var(--text-secondary)', fontSize: '1.1rem' }}>
            <p style={{ marginBottom: '1rem' }}>
              Hello! I'm Mike Wazowski, a passionate developer who loves creating things that live on the internet. My interest in web development started back when I decided to try editing custom Tumblr themes — turns out hacking together HTML & CSS taught me a lot about browsers!
            </p>
            <p>
